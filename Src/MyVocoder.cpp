...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "MyVocoder.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::exp(-(1e+04f / fConst0));
		fConst2 = 1.0f - fConst1;
		fConst3 = 0.5f * fConst0;
		iConst4 = int(fConst3);
		fConst5 = std::exp(-(1e+02f / fConst0));
		float fConst6 = std::tan(15253.406f / fConst0);
		fConst7 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst6));
		float fConst8 = 1.0f / fConst6;
		fConst9 = (fConst8 + -0.14285715f) / fConst6 + 1.0f;
		float fConst10 = (fConst8 + 0.14285715f) / fConst6 + 1.0f;
		fConst11 = 1.0f / fConst10;
		fConst12 = 1.0f / fConst0;
		fConst13 = 0.25f * fConst0;
		fConst14 = 1.0f / (fConst6 * fConst10);
		float fConst15 = std::tan(14563.748f / fConst0);
		fConst16 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst15));
		float fConst17 = 1.0f / fConst15;
		fConst18 = (fConst17 + -0.14285715f) / fConst15 + 1.0f;
		float fConst19 = (fConst17 + 0.14285715f) / fConst15 + 1.0f;
		fConst20 = 1.0f / fConst19;
		fConst21 = 1.0f / (fConst15 * fConst19);
		float fConst22 = std::tan(13890.318f / fConst0);
		fConst23 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst22));
		float fConst24 = 1.0f / fConst22;
		fConst25 = (fConst24 + -0.14285715f) / fConst22 + 1.0f;
		float fConst26 = (fConst24 + 0.14285715f) / fConst22 + 1.0f;
		fConst27 = 1.0f / fConst26;
		fConst28 = 1.0f / (fConst22 * fConst26);
		float fConst29 = std::tan(13233.115f / fConst0);
		fConst30 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst29));
		float fConst31 = 1.0f / fConst29;
		fConst32 = (fConst31 + -0.14285715f) / fConst29 + 1.0f;
		float fConst33 = (fConst31 + 0.14285715f) / fConst29 + 1.0f;
		fConst34 = 1.0f / fConst33;
		fConst35 = 1.0f / (fConst29 * fConst33);
		float fConst36 = std::tan(12592.14f / fConst0);
		fConst37 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst36));
		float fConst38 = 1.0f / fConst36;
		fConst39 = (fConst38 + -0.14285715f) / fConst36 + 1.0f;
		float fConst40 = (fConst38 + 0.14285715f) / fConst36 + 1.0f;
		fConst41 = 1.0f / fConst40;
		fConst42 = 1.0f / (fConst36 * fConst40);
		float fConst43 = std::tan(11967.391f / fConst0);
		fConst44 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst43));
		float fConst45 = 1.0f / fConst43;
		fConst46 = (fConst45 + -0.14285715f) / fConst43 + 1.0f;
		float fConst47 = (fConst45 + 0.14285715f) / fConst43 + 1.0f;
		fConst48 = 1.0f / fConst47;
		fConst49 = 1.0f / (fConst43 * fConst47);
		float fConst50 = std::tan(11358.869f / fConst0);
		fConst51 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst50));
		float fConst52 = 1.0f / fConst50;
		fConst53 = (fConst52 + -0.14285715f) / fConst50 + 1.0f;
		float fConst54 = (fConst52 + 0.14285715f) / fConst50 + 1.0f;
		fConst55 = 1.0f / fConst54;
		fConst56 = 1.0f / (fConst50 * fConst54);
		float fConst57 = std::tan(10766.575f / fConst0);
		fConst58 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst57));
		float fConst59 = 1.0f / fConst57;
		fConst60 = (fConst59 + -0.14285715f) / fConst57 + 1.0f;
		float fConst61 = (fConst59 + 0.14285715f) / fConst57 + 1.0f;
		fConst62 = 1.0f / fConst61;
		fConst63 = 1.0f / (fConst57 * fConst61);
		float fConst64 = std::tan(10190.509f / fConst0);
		fConst65 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst64));
		float fConst66 = 1.0f / fConst64;
		fConst67 = (fConst66 + -0.14285715f) / fConst64 + 1.0f;
		float fConst68 = (fConst66 + 0.14285715f) / fConst64 + 1.0f;
		fConst69 = 1.0f / fConst68;
		fConst70 = 1.0f / (fConst64 * fConst68);
		float fConst71 = std::tan(9630.669f / fConst0);
		fConst72 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst71));
		float fConst73 = 1.0f / fConst71;
		fConst74 = (fConst73 + -0.14285715f) / fConst71 + 1.0f;
		float fConst75 = (fConst73 + 0.14285715f) / fConst71 + 1.0f;
		fConst76 = 1.0f / fConst75;
		fConst77 = 1.0f / (fConst71 * fConst75);
		float fConst78 = std::tan(9087.057f / fConst0);
		fConst79 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst78));
		float fConst80 = 1.0f / fConst78;
		fConst81 = (fConst80 + -0.14285715f) / fConst78 + 1.0f;
		float fConst82 = (fConst80 + 0.14285715f) / fConst78 + 1.0f;
		fConst83 = 1.0f / fConst82;
		fConst84 = 1.0f / (fConst78 * fConst82);
		float fConst85 = std::tan(8559.672f / fConst0);
		fConst86 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst85));
		float fConst87 = 1.0f / fConst85;
		fConst88 = (fConst87 + -0.14285715f) / fConst85 + 1.0f;
		float fConst89 = (fConst87 + 0.14285715f) / fConst85 + 1.0f;
		fConst90 = 1.0f / fConst89;
		fConst91 = 1.0f / (fConst85 * fConst89);
		float fConst92 = std::tan(8048.5137f / fConst0);
		fConst93 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst92));
		float fConst94 = 1.0f / fConst92;
		fConst95 = (fConst94 + -0.14285715f) / fConst92 + 1.0f;
		float fConst96 = (fConst94 + 0.14285715f) / fConst92 + 1.0f;
		fConst97 = 1.0f / fConst96;
		fConst98 = 1.0f / (fConst92 * fConst96);
		float fConst99 = std::tan(7553.583f / fConst0);
		fConst100 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst99));
		float fConst101 = 1.0f / fConst99;
		fConst102 = (fConst101 + -0.14285715f) / fConst99 + 1.0f;
		float fConst103 = (fConst101 + 0.14285715f) / fConst99 + 1.0f;
		fConst104 = 1.0f / fConst103;
		fConst105 = 1.0f / (fConst99 * fConst103);
		float fConst106 = std::tan(7074.8794f / fConst0);
		fConst107 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst106));
		float fConst108 = 1.0f / fConst106;
		fConst109 = (fConst108 + -0.14285715f) / fConst106 + 1.0f;
		float fConst110 = (fConst108 + 0.14285715f) / fConst106 + 1.0f;
		fConst111 = 1.0f / fConst110;
		fConst112 = 1.0f / (fConst106 * fConst110);
		float fConst113 = std::tan(6612.4033f / fConst0);
		fConst114 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst113));
		float fConst115 = 1.0f / fConst113;
		fConst116 = (fConst115 + -0.14285715f) / fConst113 + 1.0f;
		float fConst117 = (fConst115 + 0.14285715f) / fConst113 + 1.0f;
		fConst118 = 1.0f / fConst117;
		fConst119 = 1.0f / (fConst113 * fConst117);
		float fConst120 = std::tan(6166.1543f / fConst0);
		fConst121 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst120));
		float fConst122 = 1.0f / fConst120;
		fConst123 = (fConst122 + -0.14285715f) / fConst120 + 1.0f;
		float fConst124 = (fConst122 + 0.14285715f) / fConst120 + 1.0f;
		fConst125 = 1.0f / fConst124;
		fConst126 = 1.0f / (fConst120 * fConst124);
		float fConst127 = std::tan(5736.133f / fConst0);
		fConst128 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst127));
		float fConst129 = 1.0f / fConst127;
		fConst130 = (fConst129 + -0.14285715f) / fConst127 + 1.0f;
		float fConst131 = (fConst129 + 0.14285715f) / fConst127 + 1.0f;
		fConst132 = 1.0f / fConst131;
		fConst133 = 1.0f / (fConst127 * fConst131);
		float fConst134 = std::tan(5322.3384f / fConst0);
		fConst135 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst134));
		float fConst136 = 1.0f / fConst134;
		fConst137 = (fConst136 + -0.14285715f) / fConst134 + 1.0f;
		float fConst138 = (fConst136 + 0.14285715f) / fConst134 + 1.0f;
		fConst139 = 1.0f / fConst138;
		fConst140 = 1.0f / (fConst134 * fConst138);
		float fConst141 = std::tan(4924.771f / fConst0);
		fConst142 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst141));
		float fConst143 = 1.0f / fConst141;
		fConst144 = (fConst143 + -0.14285715f) / fConst141 + 1.0f;
		float fConst145 = (fConst143 + 0.14285715f) / fConst141 + 1.0f;
		fConst146 = 1.0f / fConst145;
		fConst147 = 1.0f / (fConst141 * fConst145);
		float fConst148 = std::tan(4543.431f / fConst0);
		fConst149 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst148));
		float fConst150 = 1.0f / fConst148;
		fConst151 = (fConst150 + -0.14285715f) / fConst148 + 1.0f;
		float fConst152 = (fConst150 + 0.14285715f) / fConst148 + 1.0f;
		fConst153 = 1.0f / fConst152;
		fConst154 = 1.0f / (fConst148 * fConst152);
		float fConst155 = std::tan(4178.3184f / fConst0);
		fConst156 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst155));
		float fConst157 = 1.0f / fConst155;
		fConst158 = (fConst157 + -0.14285715f) / fConst155 + 1.0f;
		float fConst159 = (fConst157 + 0.14285715f) / fConst155 + 1.0f;
		fConst160 = 1.0f / fConst159;
		fConst161 = 1.0f / (fConst155 * fConst159);
		float fConst162 = std::tan(3829.4326f / fConst0);
		fConst163 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst162));
		float fConst164 = 1.0f / fConst162;
		fConst165 = (fConst164 + -0.14285715f) / fConst162 + 1.0f;
		float fConst166 = (fConst164 + 0.14285715f) / fConst162 + 1.0f;
		fConst167 = 1.0f / fConst166;
		fConst168 = 1.0f / (fConst162 * fConst166);
		float fConst169 = std::tan(3496.7744f / fConst0);
		fConst170 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst169));
		float fConst171 = 1.0f / fConst169;
		fConst172 = (fConst171 + -0.14285715f) / fConst169 + 1.0f;
		float fConst173 = (fConst171 + 0.14285715f) / fConst169 + 1.0f;
		fConst174 = 1.0f / fConst173;
		fConst175 = 1.0f / (fConst169 * fConst173);
		float fConst176 = std::tan(3180.3433f / fConst0);
		fConst177 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst176));
		float fConst178 = 1.0f / fConst176;
		fConst179 = (fConst178 + -0.14285715f) / fConst176 + 1.0f;
		float fConst180 = (fConst178 + 0.14285715f) / fConst176 + 1.0f;
		fConst181 = 1.0f / fConst180;
		fConst182 = 1.0f / (fConst176 * fConst180);
		float fConst183 = std::tan(2880.1394f / fConst0);
		fConst184 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst183));
		float fConst185 = 1.0f / fConst183;
		fConst186 = (fConst185 + -0.14285715f) / fConst183 + 1.0f;
		float fConst187 = (fConst185 + 0.14285715f) / fConst183 + 1.0f;
		fConst188 = 1.0f / fConst187;
		fConst189 = 1.0f / (fConst183 * fConst187);
		float fConst190 = std::tan(2596.1628f / fConst0);
		fConst191 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst190));
		float fConst192 = 1.0f / fConst190;
		fConst193 = (fConst192 + -0.14285715f) / fConst190 + 1.0f;
		float fConst194 = (fConst192 + 0.14285715f) / fConst190 + 1.0f;
		fConst195 = 1.0f / fConst194;
		fConst196 = 1.0f / (fConst190 * fConst194);
		float fConst197 = std::tan(2328.4136f / fConst0);
		fConst198 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst197));
		float fConst199 = 1.0f / fConst197;
		fConst200 = (fConst199 + -0.14285715f) / fConst197 + 1.0f;
		float fConst201 = (fConst199 + 0.14285715f) / fConst197 + 1.0f;
		fConst202 = 1.0f / fConst201;
		fConst203 = 1.0f / (fConst197 * fConst201);
		float fConst204 = std::tan(2076.8914f / fConst0);
		fConst205 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst204));
		float fConst206 = 1.0f / fConst204;
		fConst207 = (fConst206 + -0.14285715f) / fConst204 + 1.0f;
		float fConst208 = (fConst206 + 0.14285715f) / fConst204 + 1.0f;
		fConst209 = 1.0f / fConst208;
		fConst210 = 1.0f / (fConst204 * fConst208);
		float fConst211 = std::tan(1841.5964f / fConst0);
		fConst212 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst211));
		float fConst213 = 1.0f / fConst211;
		fConst214 = (fConst213 + -0.14285715f) / fConst211 + 1.0f;
		float fConst215 = (fConst213 + 0.14285715f) / fConst211 + 1.0f;
		fConst216 = 1.0f / fConst215;
		fConst217 = 1.0f / (fConst211 * fConst215);
		float fConst218 = std::tan(1622.5288f / fConst0);
		fConst219 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst218));
		float fConst220 = 1.0f / fConst218;
		fConst221 = (fConst220 + -0.14285715f) / fConst218 + 1.0f;
		float fConst222 = (fConst220 + 0.14285715f) / fConst218 + 1.0f;
		fConst223 = 1.0f / fConst222;
		fConst224 = 1.0f / (fConst218 * fConst222);
		float fConst225 = std::tan(1419.6884f / fConst0);
		fConst226 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst225));
		float fConst227 = 1.0f / fConst225;
		fConst228 = (fConst227 + -0.14285715f) / fConst225 + 1.0f;
		float fConst229 = (fConst227 + 0.14285715f) / fConst225 + 1.0f;
		fConst230 = 1.0f / fConst229;
		fConst231 = 1.0f / (fConst225 * fConst229);
		float fConst232 = std::tan(1233.0751f / fConst0);
		fConst233 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst232));
		float fConst234 = 1.0f / fConst232;
		fConst235 = (fConst234 + -0.14285715f) / fConst232 + 1.0f;
		float fConst236 = (fConst234 + 0.14285715f) / fConst232 + 1.0f;
		fConst237 = 1.0f / fConst236;
		fConst238 = 1.0f / (fConst232 * fConst236);
		float fConst239 = std::tan(1062.6892f / fConst0);
		fConst240 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst239));
		float fConst241 = 1.0f / fConst239;
		fConst242 = (fConst241 + -0.14285715f) / fConst239 + 1.0f;
		float fConst243 = (fConst241 + 0.14285715f) / fConst239 + 1.0f;
		fConst244 = 1.0f / fConst243;
		fConst245 = 1.0f / (fConst239 * fConst243);
		float fConst246 = std::tan(908.5304f / fConst0);
		fConst247 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst246));
		float fConst248 = 1.0f / fConst246;
		fConst249 = (fConst248 + -0.14285715f) / fConst246 + 1.0f;
		float fConst250 = (fConst248 + 0.14285715f) / fConst246 + 1.0f;
		fConst251 = 1.0f / fConst250;
		fConst252 = 1.0f / (fConst246 * fConst250);
		float fConst253 = std::tan(770.59894f / fConst0);
		fConst254 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst253));
		float fConst255 = 1.0f / fConst253;
		fConst256 = (fConst255 + -0.14285715f) / fConst253 + 1.0f;
		float fConst257 = (fConst255 + 0.14285715f) / fConst253 + 1.0f;
		fConst258 = 1.0f / fConst257;
		fConst259 = 1.0f / (fConst253 * fConst257);
		float fConst260 = std::tan(648.89465f / fConst0);
		fConst261 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst260));
		float fConst262 = 1.0f / fConst260;
		fConst263 = (fConst262 + -0.14285715f) / fConst260 + 1.0f;
		float fConst264 = (fConst262 + 0.14285715f) / fConst260 + 1.0f;
		fConst265 = 1.0f / fConst264;
		fConst266 = 1.0f / (fConst260 * fConst264);
		float fConst267 = std::tan(543.41766f / fConst0);
		fConst268 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst267));
		float fConst269 = 1.0f / fConst267;
		fConst270 = (fConst269 + -0.14285715f) / fConst267 + 1.0f;
		float fConst271 = (fConst269 + 0.14285715f) / fConst267 + 1.0f;
		fConst272 = 1.0f / fConst271;
		fConst273 = 1.0f / (fConst267 * fConst271);
		float fConst274 = std::tan(454.16785f / fConst0);
		fConst275 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst274));
		float fConst276 = 1.0f / fConst274;
		fConst277 = (fConst276 + -0.14285715f) / fConst274 + 1.0f;
		float fConst278 = (fConst276 + 0.14285715f) / fConst274 + 1.0f;
		fConst279 = 1.0f / fConst278;
		fConst280 = 1.0f / (fConst274 * fConst278);
		float fConst281 = std::tan(381.1453f / fConst0);
		fConst282 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst281));
		float fConst283 = 1.0f / fConst281;
		fConst284 = (fConst283 + -0.14285715f) / fConst281 + 1.0f;
		float fConst285 = (fConst283 + 0.14285715f) / fConst281 + 1.0f;
		fConst286 = 1.0f / fConst285;
		fConst287 = 1.0f / (fConst281 * fConst285);
		float fConst288 = std::tan(324.34998f / fConst0);
		fConst289 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst288));
		float fConst290 = 1.0f / fConst288;
		fConst291 = (fConst290 + -0.14285715f) / fConst288 + 1.0f;
		float fConst292 = (fConst290 + 0.14285715f) / fConst288 + 1.0f;
		fConst293 = 1.0f / fConst292;
		fConst294 = 1.0f / (fConst288 * fConst292);
		float fConst295 = std::tan(283.7819f / fConst0);
		fConst296 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst295));
		float fConst297 = 1.0f / fConst295;
		fConst298 = (fConst297 + -0.14285715f) / fConst295 + 1.0f;
		float fConst299 = (fConst297 + 0.14285715f) / fConst295 + 1.0f;
		fConst300 = 1.0f / fConst299;
		fConst301 = 1.0f / (fConst295 * fConst299);
		float fConst302 = std::tan(259.44104f / fConst0);
		fConst303 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst302));
		float fConst304 = 1.0f / fConst302;
		fConst305 = (fConst304 + -0.14285715f) / fConst302 + 1.0f;
		float fConst306 = (fConst304 + 0.14285715f) / fConst302 + 1.0f;
		fConst307 = 1.0f / fConst306;
		fConst308 = 1.0f / (fConst302 * fConst306);
		float fConst309 = std::tan(251.32741f / fConst0);
		fConst310 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst309));
		float fConst311 = 1.0f / fConst309;
		fConst312 = (fConst311 + -0.14285715f) / fConst309 + 1.0f;
		float fConst313 = (fConst311 + 0.14285715f) / fConst309 + 1.0f;
		fConst314 = 1.0f / fConst313;
		fConst315 = 1.0f / (fConst309 * fConst313);
	}
	
	virtual void instanceResetUserInterface() {
		fButton0 = FAUSTFLOAT(0.0f);
		fHslider0 = FAUSTFLOAT(1.5e+02f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("MyVocoder");
		ui_interface->addButton("Activate", &fButton0);
		ui_interface->openVerticalBox("Vocoder");
		ui_interface->declare(&fHslider1, "1", "");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->declare(&fHslider1, "tooltip", "Attack / Release time in seconds");
		ui_interface->addHorizontalSlider("AttRel", &fHslider1, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.001f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider0, "2", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("Freq", &fHslider0, FAUSTFLOAT(1.5e+02f), FAUSTFLOAT(5e+01f), FAUSTFLOAT(5e+02f), FAUSTFLOAT(2.0f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = std::max<float>(float(fHslider0), 23.44895f);
		float fSlow2 = std::max<float>(2e+01f, std::fabs(fSlow1));
		float fSlow3 = fConst12 * fSlow2;
		float fSlow4 = fConst13 / fSlow2;
		...
		float fSlow11 = 0.0001f * float(fHslider1);
		int iSlow12 = std::fabs(fSlow11) < 1.1920929e-07f;
		float fSlow13 = ((iSlow12) ? 0.0f : std::exp(-(fConst12 / ((iSlow12) ? 1.0f : fSlow11))));
		float fSlow14 = 1.0f - fSlow13;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			float fTemp0 = float(input0[i0]);
			fRec1[0] = fConst2 * std::fabs(fTemp0) + fConst1 * fRec1[1];
			int iTemp1 = fRec1[0] > 0.01f;
			iVec1[0] = iTemp1;
			iRec2[0] = std::max<int>(iConst4 * (iTemp1 < iVec1[1]), iRec2[1] + -1);
			float fTemp2 = std::fabs(std::max<float>(float(iTemp1), float(iRec2[0] > 0)));
			float fTemp3 = ((fTemp2 > fRec0[1]) ? fConst1 : fConst5);
			fRec0[0] = fTemp2 * (1.0f - fTemp3) + fRec0[1] * fTemp3;
			float fTemp4 = fTemp0 * fRec0[0];
			float fTemp5 = ((1 - iVec0[1]) ? 0.0f : fSlow3 + fRec4[1]);
			fRec4[0] = fTemp5 - std::floor(fTemp5);
			float fTemp6 = mydsp_faustpower2_f(2.0f * fRec4[0] + -1.0f);
			fVec2[0] = fTemp6;
			float fTemp7 = fSlow4 * float(iVec0[1]) * (fTemp6 - fVec2[1]);
			fVec3[IOTA0 & 2047] = fTemp7;
			float fTemp8 = fSlow10 * fVec3[(IOTA0 - iSlow6) & 2047] + fSlow9 * fVec3[(IOTA0 - iSlow7) & 2047];
			fRec3[0] = fTemp7 - (fTemp8 + fConst11 * (fConst9 * fRec3[2] + fConst7 * fRec3[1]));
			fRec6[0] = fTemp4 - fConst11 * (fConst9 * fRec6[2] + fConst7 * fRec6[1]);
			fRec5[0] = fSlow14 * std::fabs(fConst14 * (fRec6[0] - fRec6[2])) + fSlow13 * fRec5[1];
			fRec7[0] = fTemp7 - (fTemp8 + fConst20 * (fConst18 * fRec7[2] + fConst16 * fRec7[1]));
			fRec9[0] = fTemp4 - fConst20 * (fConst18 * fRec9[2] + fConst16 * fRec9[1]);
			fRec8[0] = fSlow14 * std::fabs(fConst21 * (fRec9[0] - fRec9[2])) + fSlow13 * fRec8[1];
			fRec10[0] = fTemp7 - (fTemp8 + fConst27 * (fConst25 * fRec10[2] + fConst23 * fRec10[1]));
			fRec12[0] = fTemp4 - fConst27 * (fConst25 * fRec12[2] + fConst23 * fRec12[1]);
			fRec11[0] = fSlow14 * std::fabs(fConst28 * (fRec12[0] - fRec12[2])) + fSlow13 * fRec11[1];
			fRec13[0] = fTemp7 - (fTemp8 + fConst34 * (fConst32 * fRec13[2] + fConst30 * fRec13[1]));
			fRec15[0] = fTemp4 - fConst34 * (fConst32 * fRec15[2] + fConst30 * fRec15[1]);
			fRec14[0] = fSlow14 * std::fabs(fConst35 * (fRec15[0] - fRec15[2])) + fSlow13 * fRec14[1];
			fRec16[0] = fTemp7 - (fTemp8 + fConst41 * (fConst39 * fRec16[2] + fConst37 * fRec16[1]));
			fRec18[0] = fTemp4 - fConst41 * (fConst39 * fRec18[2] + fConst37 * fRec18[1]);
			fRec17[0] = fSlow14 * std::fabs(fConst42 * (fRec18[0] - fRec18[2])) + fSlow13 * fRec17[1];
			fRec19[0] = fTemp7 - (fTemp8 + fConst48 * (fConst46 * fRec19[2] + fConst44 * fRec19[1]));
			fRec21[0] = fTemp4 - fConst48 * (fConst46 * fRec21[2] + fConst44 * fRec21[1]);
			fRec20[0] = fSlow14 * std::fabs(fConst49 * (fRec21[0] - fRec21[2])) + fSlow13 * fRec20[1];
			fRec22[0] = fTemp7 - (fTemp8 + fConst55 * (fConst53 * fRec22[2] + fConst51 * fRec22[1]));
			fRec24[0] = fTemp4 - fConst55 * (fConst53 * fRec24[2] + fConst51 * fRec24[1]);
			fRec23[0] = fSlow14 * std::fabs(fConst56 * (fRec24[0] - fRec24[2])) + fSlow13 * fRec23[1];
			fRec25[0] = fTemp7 - (fTemp8 + fConst62 * (fConst60 * fRec25[2] + fConst58 * fRec25[1]));
			fRec27[0] = fTemp4 - fConst62 * (fConst60 * fRec27[2] + fConst58 * fRec27[1]);
			fRec26[0] = fSlow14 * std::fabs(fConst63 * (fRec27[0] - fRec27[2])) + fSlow13 * fRec26[1];
			fRec28[0] = fTemp7 - (fTemp8 + fConst69 * (fConst67 * fRec28[2] + fConst65 * fRec28[1]));
			fRec30[0] = fTemp4 - fConst69 * (fConst67 * fRec30[2] + fConst65 * fRec30[1]);
			fRec29[0] = fSlow14 * std::fabs(fConst70 * (fRec30[0] - fRec30[2])) + fSlow13 * fRec29[1];
			fRec31[0] = fTemp7 - (fTemp8 + fConst76 * (fConst74 * fRec31[2] + fConst72 * fRec31[1]));
			fRec33[0] = fTemp4 - fConst76 * (fConst74 * fRec33[2] + fConst72 * fRec33[1]);
			fRec32[0] = fSlow14 * std::fabs(fConst77 * (fRec33[0] - fRec33[2])) + fSlow13 * fRec32[1];
			fRec34[0] = fTemp7 - (fTemp8 + fConst83 * (fConst81 * fRec34[2] + fConst79 * fRec34[1]));
			fRec36[0] = fTemp4 - fConst83 * (fConst81 * fRec36[2] + fConst79 * fRec36[1]);
			fRec35[0] = fSlow14 * std::fabs(fConst84 * (fRec36[0] - fRec36[2])) + fSlow13 * fRec35[1];
			fRec37[0] = fTemp7 - (fTemp8 + fConst90 * (fConst88 * fRec37[2] + fConst86 * fRec37[1]));
			fRec39[0] = fTemp4 - fConst90 * (fConst88 * fRec39[2] + fConst86 * fRec39[1]);
			fRec38[0] = fSlow14 * std::fabs(fConst91 * (fRec39[0] - fRec39[2])) + fSlow13 * fRec38[1];
			fRec40[0] = fTemp7 - (fTemp8 + fConst97 * (fConst95 * fRec40[2] + fConst93 * fRec40[1]));
			fRec42[0] = fTemp4 - fConst97 * (fConst95 * fRec42[2] + fConst93 * fRec42[1]);
			fRec41[0] = fSlow14 * std::fabs(fConst98 * (fRec42[0] - fRec42[2])) + fSlow13 * fRec41[1];
			fRec43[0] = fTemp7 - (fTemp8 + fConst104 * (fConst102 * fRec43[2] + fConst100 * fRec43[1]));
			fRec45[0] = fTemp4 - fConst104 * (fConst102 * fRec45[2] + fConst100 * fRec45[1]);
			fRec44[0] = fSlow14 * std::fabs(fConst105 * (fRec45[0] - fRec45[2])) + fSlow13 * fRec44[1];
			fRec46[0] = fTemp7 - (fTemp8 + fConst111 * (fConst109 * fRec46[2] + fConst107 * fRec46[1]));
			fRec48[0] = fTemp4 - fConst111 * (fConst109 * fRec48[2] + fConst107 * fRec48[1]);
			fRec47[0] = fSlow14 * std::fabs(fConst112 * (fRec48[0] - fRec48[2])) + fSlow13 * fRec47[1];
			fRec49[0] = fTemp7 - (fTemp8 + fConst118 * (fConst116 * fRec49[2] + fConst114 * fRec49[1]));
			fRec51[0] = fTemp4 - fConst118 * (fConst116 * fRec51[2] + fConst114 * fRec51[1]);
			fRec50[0] = fSlow14 * std::fabs(fConst119 * (fRec51[0] - fRec51[2])) + fSlow13 * fRec50[1];
			fRec52[0] = fTemp7 - (fTemp8 + fConst125 * (fConst123 * fRec52[2] + fConst121 * fRec52[1]));
			fRec54[0] = fTemp4 - fConst125 * (fConst123 * fRec54[2] + fConst121 * fRec54[1]);
			fRec53[0] = fSlow14 * std::fabs(fConst126 * (fRec54[0] - fRec54[2])) + fSlow13 * fRec53[1];
			fRec55[0] = fTemp7 - (fTemp8 + fConst132 * (fConst130 * fRec55[2] + fConst128 * fRec55[1]));
			fRec57[0] = fTemp4 - fConst132 * (fConst130 * fRec57[2] + fConst128 * fRec57[1]);
			fRec56[0] = fSlow14 * std::fabs(fConst133 * (fRec57[0] - fRec57[2])) + fSlow13 * fRec56[1];
			fRec58[0] = fTemp7 - (fTemp8 + fConst139 * (fConst137 * fRec58[2] + fConst135 * fRec58[1]));
			fRec60[0] = fTemp4 - fConst139 * (fConst137 * fRec60[2] + fConst135 * fRec60[1]);
			fRec59[0] = fSlow14 * std::fabs(fConst140 * (fRec60[0] - fRec60[2])) + fSlow13 * fRec59[1];
			fRec61[0] = fTemp7 - (fTemp8 + fConst146 * (fConst144 * fRec61[2] + fConst142 * fRec61[1]));
			fRec63[0] = fTemp4 - fConst146 * (fConst144 * fRec63[2] + fConst142 * fRec63[1]);
			fRec62[0] = fSlow14 * std::fabs(fConst147 * (fRec63[0] - fRec63[2])) + fSlow13 * fRec62[1];
			fRec64[0] = fTemp7 - (fTemp8 + fConst153 * (fConst151 * fRec64[2] + fConst149 * fRec64[1]));
			fRec66[0] = fTemp4 - fConst153 * (fConst151 * fRec66[2] + fConst149 * fRec66[1]);
			fRec65[0] = fSlow14 * std::fabs(fConst154 * (fRec66[0] - fRec66[2])) + fSlow13 * fRec65[1];
			fRec67[0] = fTemp7 - (fTemp8 + fConst160 * (fConst158 * fRec67[2] + fConst156 * fRec67[1]));
			fRec69[0] = fTemp4 - fConst160 * (fConst158 * fRec69[2] + fConst156 * fRec69[1]);
			fRec68[0] = fSlow14 * std::fabs(fConst161 * (fRec69[0] - fRec69[2])) + fSlow13 * fRec68[1];
			fRec70[0] = fTemp7 - (fTemp8 + fConst167 * (fConst165 * fRec70[2] + fConst163 * fRec70[1]));
			fRec72[0] = fTemp4 - fConst167 * (fConst165 * fRec72[2] + fConst163 * fRec72[1]);
			fRec71[0] = fSlow14 * std::fabs(fConst168 * (fRec72[0] - fRec72[2])) + fSlow13 * fRec71[1];
			fRec73[0] = fTemp7 - (fTemp8 + fConst174 * (fConst172 * fRec73[2] + fConst170 * fRec73[1]));
			fRec75[0] = fTemp4 - fConst174 * (fConst172 * fRec75[2] + fConst170 * fRec75[1]);
			fRec74[0] = fSlow14 * std::fabs(fConst175 * (fRec75[0] - fRec75[2])) + fSlow13 * fRec74[1];
			fRec76[0] = fTemp7 - (fTemp8 + fConst181 * (fConst179 * fRec76[2] + fConst177 * fRec76[1]));
			fRec78[0] = fTemp4 - fConst181 * (fConst179 * fRec78[2] + fConst177 * fRec78[1]);
			fRec77[0] = fSlow14 * std::fabs(fConst182 * (fRec78[0] - fRec78[2])) + fSlow13 * fRec77[1];
			fRec79[0] = fTemp7 - (fTemp8 + fConst188 * (fConst186 * fRec79[2] + fConst184 * fRec79[1]));
			fRec81[0] = fTemp4 - fConst188 * (fConst186 * fRec81[2] + fConst184 * fRec81[1]);
			fRec80[0] = fSlow14 * std::fabs(fConst189 * (fRec81[0] - fRec81[2])) + fSlow13 * fRec80[1];
			fRec82[0] = fTemp7 - (fTemp8 + fConst195 * (fConst193 * fRec82[2] + fConst191 * fRec82[1]));
			fRec84[0] = fTemp4 - fConst195 * (fConst193 * fRec84[2] + fConst191 * fRec84[1]);
			fRec83[0] = fSlow14 * std::fabs(fConst196 * (fRec84[0] - fRec84[2])) + fSlow13 * fRec83[1];
			fRec85[0] = fTemp7 - (fTemp8 + fConst202 * (fConst200 * fRec85[2] + fConst198 * fRec85[1]));
			fRec87[0] = fTemp4 - fConst202 * (fConst200 * fRec87[2] + fConst198 * fRec87[1]);
			fRec86[0] = fSlow14 * std::fabs(fConst203 * (fRec87[0] - fRec87[2])) + fSlow13 * fRec86[1];
			fRec88[0] = fTemp7 - (fTemp8 + fConst209 * (fConst207 * fRec88[2] + fConst205 * fRec88[1]));
			fRec90[0] = fTemp4 - fConst209 * (fConst207 * fRec90[2] + fConst205 * fRec90[1]);
			fRec89[0] = fSlow14 * std::fabs(fConst210 * (fRec90[0] - fRec90[2])) + fSlow13 * fRec89[1];
			fRec91[0] = fTemp7 - (fTemp8 + fConst216 * (fConst214 * fRec91[2] + fConst212 * fRec91[1]));
			fRec93[0] = fTemp4 - fConst216 * (fConst214 * fRec93[2] + fConst212 * fRec93[1]);
			fRec92[0] = fSlow14 * std::fabs(fConst217 * (fRec93[0] - fRec93[2])) + fSlow13 * fRec92[1];
			fRec94[0] = fTemp7 - (fTemp8 + fConst223 * (fConst221 * fRec94[2] + fConst219 * fRec94[1]));
			fRec96[0] = fTemp4 - fConst223 * (fConst221 * fRec96[2] + fConst219 * fRec96[1]);
			fRec95[0] = fSlow14 * std::fabs(fConst224 * (fRec96[0] - fRec96[2])) + fSlow13 * fRec95[1];
			fRec97[0] = fTemp7 - (fTemp8 + fConst230 * (fConst228 * fRec97[2] + fConst226 * fRec97[1]));
			fRec99[0] = fTemp4 - fConst230 * (fConst228 * fRec99[2] + fConst226 * fRec99[1]);
			fRec98[0] = fSlow14 * std::fabs(fConst231 * (fRec99[0] - fRec99[2])) + fSlow13 * fRec98[1];
			fRec100[0] = fTemp7 - (fTemp8 + fConst237 * (fConst235 * fRec100[2] + fConst233 * fRec100[1]));
			fRec102[0] = fTemp4 - fConst237 * (fConst235 * fRec102[2] + fConst233 * fRec102[1]);
			fRec101[0] = fSlow14 * std::fabs(fConst238 * (fRec102[0] - fRec102[2])) + fSlow13 * fRec101[1];
			fRec103[0] = fTemp7 - (fTemp8 + fConst244 * (fConst242 * fRec103[2] + fConst240 * fRec103[1]));
			fRec105[0] = fTemp4 - fConst244 * (fConst242 * fRec105[2] + fConst240 * fRec105[1]);
			fRec104[0] = fSlow14 * std::fabs(fConst245 * (fRec105[0] - fRec105[2])) + fSlow13 * fRec104[1];
			fRec106[0] = fTemp7 - (fTemp8 + fConst251 * (fConst249 * fRec106[2] + fConst247 * fRec106[1]));
			fRec108[0] = fTemp4 - fConst251 * (fConst249 * fRec108[2] + fConst247 * fRec108[1]);
			fRec107[0] = fSlow14 * std::fabs(fConst252 * (fRec108[0] - fRec108[2])) + fSlow13 * fRec107[1];
			fRec109[0] = fTemp7 - (fTemp8 + fConst258 * (fConst256 * fRec109[2] + fConst254 * fRec109[1]));
			fRec111[0] = fTemp4 - fConst258 * (fConst256 * fRec111[2] + fConst254 * fRec111[1]);
			fRec110[0] = fSlow14 * std::fabs(fConst259 * (fRec111[0] - fRec111[2])) + fSlow13 * fRec110[1];
			fRec112[0] = fTemp7 - (fTemp8 + fConst265 * (fConst263 * fRec112[2] + fConst261 * fRec112[1]));
			fRec114[0] = fTemp4 - fConst265 * (fConst263 * fRec114[2] + fConst261 * fRec114[1]);
			fRec113[0] = fSlow14 * std::fabs(fConst266 * (fRec114[0] - fRec114[2])) + fSlow13 * fRec113[1];
			fRec115[0] = fTemp7 - (fTemp8 + fConst272 * (fConst270 * fRec115[2] + fConst268 * fRec115[1]));
			fRec117[0] = fTemp4 - fConst272 * (fConst270 * fRec117[2] + fConst268 * fRec117[1]);
			fRec116[0] = fSlow14 * std::fabs(fConst273 * (fRec117[0] - fRec117[2])) + fSlow13 * fRec116[1];
			fRec118[0] = fTemp7 - (fTemp8 + fConst279 * (fConst277 * fRec118[2] + fConst275 * fRec118[1]));
			fRec120[0] = fTemp4 - fConst279 * (fConst277 * fRec120[2] + fConst275 * fRec120[1]);
			fRec119[0] = fSlow14 * std::fabs(fConst280 * (fRec120[0] - fRec120[2])) + fSlow13 * fRec119[1];
			fRec121[0] = fTemp7 - (fTemp8 + fConst286 * (fConst284 * fRec121[2] + fConst282 * fRec121[1]));
			fRec123[0] = fTemp4 - fConst286 * (fConst284 * fRec123[2] + fConst282 * fRec123[1]);
			fRec122[0] = fSlow14 * std::fabs(fConst287 * (fRec123[0] - fRec123[2])) + fSlow13 * fRec122[1];
			fRec124[0] = fTemp7 - (fTemp8 + fConst293 * (fConst291 * fRec124[2] + fConst289 * fRec124[1]));
			fRec126[0] = fTemp4 - fConst293 * (fConst291 * fRec126[2] + fConst289 * fRec126[1]);
			fRec125[0] = fSlow14 * std::fabs(fConst294 * (fRec126[0] - fRec126[2])) + fSlow13 * fRec125[1];
			fRec127[0] = fTemp7 - (fTemp8 + fConst300 * (fConst298 * fRec127[2] + fConst296 * fRec127[1]));
			fRec129[0] = fTemp4 - fConst300 * (fConst298 * fRec129[2] + fConst296 * fRec129[1]);
			fRec128[0] = fSlow14 * std::fabs(fConst301 * (fRec129[0] - fRec129[2])) + fSlow13 * fRec128[1];
			fRec130[0] = fTemp7 - (fTemp8 + fConst307 * (fConst305 * fRec130[2] + fConst303 * fRec130[1]));
			fRec132[0] = fTemp4 - fConst307 * (fConst305 * fRec132[2] + fConst303 * fRec132[1]);
			fRec131[0] = fSlow14 * std::fabs(fConst308 * (fRec132[0] - fRec132[2])) + fSlow13 * fRec131[1];
			fRec133[0] = fTemp7 - (fTemp8 + fConst314 * (fConst312 * fRec133[2] + fConst310 * fRec133[1]));
			fRec135[0] = fTemp4 - fConst314 * (fConst312 * fRec135[2] + fConst310 * fRec135[1]);
			fRec134[0] = std::fabs(fConst315 * (fRec135[0] - fRec135[2])) * fSlow14 + fRec134[1] * fSlow13;
			float fTemp9 = ((iSlow0) ? fConst315 * fRec134[0] * (fRec133[0] - fRec133[2]) + fConst308 * fRec131[0] * (fRec130[0] - fRec130[2]) + fConst301 * fRec128[0] * (fRec127[0] - fRec127[2]) + fConst294 * fRec125[0] * (fRec124[0] - fRec124[2]) + fConst287 * fRec122[0] * (fRec121[0] - fRec121[2]) + fConst280 * fRec119[0] * (fRec118[0] - fRec118[2]) + fConst273 * fRec116[0] * (fRec115[0] - fRec115[2]) + fConst266 * fRec113[0] * (fRec112[0] - fRec112[2]) + fConst259 * fRec110[0] * (fRec109[0] - fRec109[2]) + fConst252 * fRec107[0] * (fRec106[0] - fRec106[2]) + fConst245 * fRec104[0] * (fRec103[0] - fRec103[2]) + fConst238 * fRec101[0] * (fRec100[0] - fRec100[2]) + fConst231 * fRec98[0] * (fRec97[0] - fRec97[2]) + fConst224 * fRec95[0] * (fRec94[0] - fRec94[2]) + fConst217 * fRec92[0] * (fRec91[0] - fRec91[2]) + fConst210 * fRec89[0] * (fRec88[0] - fRec88[2]) + fConst203 * fRec86[0] * (fRec85[0] - fRec85[2]) + fConst196 * fRec83[0] * (fRec82[0] - fRec82[2]) + fConst189 * fRec80[0] * (fRec79[0] - fRec79[2]) + fConst182 * fRec77[0] * (fRec76[0] - fRec76[2]) + fConst175 * fRec74[0] * (fRec73[0] - fRec73[2]) + fConst168 * fRec71[0] * (fRec70[0] - fRec70[2]) + fConst161 * fRec68[0] * (fRec67[0] - fRec67[2]) + fConst154 * fRec65[0] * (fRec64[0] - fRec64[2]) + fConst147 * fRec62[0] * (fRec61[0] - fRec61[2]) + fConst140 * fRec59[0] * (fRec58[0] - fRec58[2]) + fConst133 * fRec56[0] * (fRec55[0] - fRec55[2]) + fConst126 * fRec53[0] * (fRec52[0] - fRec52[2]) + fConst119 * fRec50[0] * (fRec49[0] - fRec49[2]) + fConst112 * fRec47[0] * (fRec46[0] - fRec46[2]) + fConst105 * fRec44[0] * (fRec43[0] - fRec43[2]) + fConst98 * fRec41[0] * (fRec40[0] - fRec40[2]) + fConst91 * fRec38[0] * (fRec37[0] - fRec37[2]) + fConst84 * fRec35[0] * (fRec34[0] - fRec34[2]) + fConst77 * fRec32[0] * (fRec31[0] - fRec31[2]) + fConst70 * fRec29[0] * (fRec28[0] - fRec28[2]) + fConst63 * fRec26[0] * (fRec25[0] - fRec25[2]) + fConst56 * fRec23[0] * (fRec22[0] - fRec22[2]) + fConst49 * fRec20[0] * (fRec19[0] - fRec19[2]) + fConst42 * fRec17[0] * (fRec16[0] - fRec16[2]) + fConst35 * fRec14[0] * (fRec13[0] - fRec13[2]) + fConst28 * fRec11[0] * (fRec10[0] - fRec10[2]) + fConst21 * fRec8[0] * (fRec7[0] - fRec7[2]) + fConst14 * fRec5[0] * (fRec3[0] - fRec3[2]) : fTemp4);
	...
	#define FAUST_FILE_NAME "MyVocoder.dsp"
	...
	FAUST_ADDBUTTON("Activate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("Vocoder/AttRel", fHslider1, 0.1f, 0.001f, 1.0f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Vocoder/Freq", fHslider0, 1.5e+02f, 5e+01f, 5e+02f, 2.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(BUTTON, Activate, "Activate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, AttRel, "Vocoder/AttRel", fHslider1, 0.1f, 0.001f, 1.0f, 0.1f) \
		p(HORIZONTALSLIDER, Freq, "Vocoder/Freq", fHslider0, 1.5e+02f, 5e+01f, 5e+02f, 2.0f) \
...
MyVocoder::MyVocoder() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void MyVocoder::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void MyVocoder::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float MyVocoder::getParamValue(const std::string& path)
{
